...
PURE RECURSIVE FUNCTION DNRMP(P, M, X) RESULT(F)
  ...
  IMPLICIT NONE
  INTERFACE
     PURE RECURSIVE DOUBLE PRECISION FUNCTION DNRM1(M, X)
       IMPLICIT NONE
       INTEGER, INTENT(IN) :: M
  ...
  END INTERFACE
  INTERFACE
     PURE RECURSIVE DOUBLE PRECISION FUNCTION DNRMF(M, X)
       IMPLICIT NONE
       INTEGER, INTENT(IN) :: M
       DOUBLE PRECISION, INTENT(IN) :: X(M)
     END FUNCTION DNRMF
  END INTERFACE
  INTERFACE
     PURE RECURSIVE DOUBLE PRECISION FUNCTION DNRMI(M, X)
       IMPLICIT NONE
       INTEGER, INTENT(IN) :: M
       DOUBLE PRECISION, INTENT(IN) :: X(M)
     END FUNCTION DNRMI
