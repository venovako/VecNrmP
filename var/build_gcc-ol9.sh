...
then
	...
	then
		cd ../../libpvn/src
		scl enable gcc-toolset-14 "make COMPILER=gcc NDEBUG=3 SAFE=DET,SV2,NRM VECLEN=64 GMP=/opt/gmp MPFR=/opt/mpfr SLEEF=/opt/sleef MARCH=${TGT} STATIC=-s clean all"
		cd ../../cgic
